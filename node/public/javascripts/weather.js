function getWeather() {
	...
	woeid: '',
        ...
        success: function(weather) {
            ...
            html += '<div class="large-3 columns">Current</div>';
            html += '<div class="large-3 columns">' + weather.forecast[0].day + '</div>';
            html += '<div class="large-3 columns">' + weather.forecast[1].day + '</div>';
            html += '<div class="large-3 columns">' + weather.forecast[2].day + '</div>';
            html += '</div></span>';
		...
		console.log(weather.temp);            
            ...
            html += '<div class="row">';
            html += '<div class="large-3 columns"><img src="images/weather/' + weather.code + '.png"><br/>';
	    ...
	    html += '</div><div class="large-3 columns"><img src="images/weather/' + weather.forecast[0].code + '.png"><br/>';
            html += '<span class="weather-temp">' + weather.forecast[0].alt.high + '&deg; / ' + weather.forecast[0].alt.low + '&deg;</span></div>';
            html += '<div class="large-3 columns"><img src="images/weather/' + weather.forecast[1].code + '.png"><br/>';
            html += '<span class="weather-temp">' + weather.forecast[1].alt.high + '&deg; / ' + weather.forecast[1].alt.low + '&deg;</span></div>';
            html += '<div class="large-3 columns"><img src="images/weather/' + weather.forecast[2].code + '.png"><br/>';
