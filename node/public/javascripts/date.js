...
function getDate() {
  ...
  var seniors = [
  ['Norman'], ['Kim', '#ADFFAD'], ['Becky', 'purple'], ['KYC', 'orange'], 
  ['Staly', '#228B22'], ['Josh Josh'], ['Sumit', '#6FA252'],
  ['Fish', '#A5CCA1'], ['Hunter'], ['Hans'], ['Michael X'],
  ['Tommy'], ['Eva', '#daf5ba'], ['Natalle', '#4099FF'], ['Shanthi'], 
  ['Kev Hu'], ['Yi-Shiuan'], ['Jeff'], ['Corzo'], ['Jenny', '#ff69b4']
  ['Jennie Z', '#8C0D1C'], ['Michael W'], ['Saya'], ['Tony']];
  ...
  if (graduation && now.getSeconds()%10 == 0) {
    if ($('#news').find('img').css('display') == 'none') {
    } else {
