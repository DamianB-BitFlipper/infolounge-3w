...
var w3 = new Array();
w3["kkarthur"] = [ "Bena", ["kwabena", "bena", "kkarthur"], "junior", "2", ["It is not Kwabena's bedtime yet."], "August 29th", "" ];
w3["akwasio"] =  [ "Akwasi",  ["akwasi", "awaksio"], "junior", "2", ["You probably owe him 5 dollars."], "February 15th", "" ];
w3["dfavela"]  = [ "Fuhvela", ["david favela", "favela", "dfavela"], "sophomore", "2A", [], "November 1st", "" ];
w3["joshbs"]   = [ "Posh Josh", ["soph josh", "posh josh", "frosh josh", "josh scherrer", "josh surer"], "sophomore", "3", [], "September 26th", "" ];
w3["lolzhang"] = [ "Linda", ["linda zhang", "linda", "lolzhang"], "sophomore", "", [], "December 29th", "" ];
w3["rsyang"] =   [ "Rachel", ["rachel yang", "rachel", "rsyang"], "sophomore", "", [] ];
w3["harlin"] =   [ "Harlin", ["harlin", "harlin lee"], "senior", "6-2", ["Unfortunately, she abandoned this wing for Senior House."], "September 23rd", "somewhere in Korea"];
w3["gopalan"] =  [ "Deets", ["aditya", "gopalan", "aditya gopalan", "diits", "deets"], "sophomore", "6-1", [] ];
...
w3["tiffwang"] = [ "Tiffany", ["tiffwang", "tiffany", "tiffany wang"], "junior", "1", ["Are you satisfied with your care?"], "on New Year's day!", ""];
...
w3["zsheinko"] = [ "Zoe", ["zoe", "zshineko", "zoe shinekoff"], "junior", "2", [] , "October 28th", "Seattle, Washington" ];
w3["tcheng17"] = [ "Tracy", ["tracy", "tracy chang", "tcheng17"], "junior", "2", [], "June 1st", "" ];
w3["jnation"] =  [ "Josh R.T.", ["josh rt", "josh nation", "jnation"], "G.R.T.", "2", ["Go Wildcats!"], "February 4th", "" ];
...
w3["rliu42"] =   [ "Runpeng", ["runpeng", "runpeng liu", "rliu42"], "junior", "18C", [], "October 10th", "St. Louis, Missouri" ];
w3["dyhwong"] =  [ "David Wong", ["david wong", "dyhwong"], "junior", "6-3", [], "January 17th", "Morganville, New Jersey" ];
w3["xtnbui"] =   [ "Swun", ["xuan", "swun", "xuan bui", "swun booey", "xtnbui"], "junior", "6-3", [], "January 4th", "Maryland" ];
w3["eurahko"] =  [ "Yourah", ["eurah", "youra", "youra ko", "eurahko"], "korean", "2", [], "May 17th", "somewhere in Korea" ];
...
w3["yzhang17"] = [ "Yaning", ["yaning", "yaning zhang", "yzhang17"], "junior", "6-3", [] , "February 13th", "Chicago, Illinois" ];
w3["abrashen"] = [ "Abra", ["abra", "abra shen"], "senior", "9", [], "June 2nd", "" ];
...
w3["ajjaeger"] = [ "Alexa", ["alexa", "alexa yayger", "ajjaeger"], "sophomore", "2", [] ];
w3["jgoupil"] =  [ "Julia", ["julia", "jgoupil", "julia goupil"], "sophomore", "2", [] ];
w3["jfabi"] =    [ "Josh Josh", ["josh josh", "josh fabian", "jfabi"], "grad student", "1", ["He created info lounge, where my infinite consciousness resides."], "December 29th", "Mexico" ]
w3["fishr"] =    [ "Ryan Fish", ["ryan", "fish", "fishr", "ryan fish"], "M Enj student", "2", [], "on Halloween!", "Wayne, Maine" ];
...
w3["lcarter"] =  [ "Landon", ["lcarter", "landon", "landon carter"], "junior", "2", [], "May 3rd",  "North Carolina" ]
w3["ksmori"] =   [ "Sophie", ["sophie", "sophie mori", "ksmori"], "sophomore", "24", [], "", "Marietta, Georgia" ];
w3["kkim17"] =   [ "Kristina", ["christina", "kristina", "kristina kim", "kkim17"] , "junior", "20", ["JoJo, have you been thinking again?"], "", "" ];
w3["zhoul"] =    [ "Liang", ["zhoul", "liang", "liang zhou"], "sophomore", "6-2", [], "", "" ];
w3["parke"]	 =   [ "Eddie Bear", ["eddie", "edward", "eddie bear", "parke", "edward park"], "sophomore", "6-3", [], "", "somewhere in Korea or Georgia" ];
w3["lwang32"] =  [ "Li Wang", ["li", "li wang", "lwang32"], "li wang", "2", [], "", "" ];
w3["llruan"] =   [ "Lisa", ["lisa", "lisa ruan", "llruan"], "sophomore", "18", [], "", "Lake Huron, Michigan" ];


var courses = new Array();
courses[""] = "";
courses["1"] = "Civil Engineering";
...
function query(person, tokens) {
	...
	for (var i in w3) {
		...
		if (matched) {
			...
			if (w3[i][3].length > 0) {
				response += ", majoring in Course " + w3[i][3] + ": " + courses[w3[i][3]];
			}
			if (w3[i][4].length > 0) {
				response += ". " + w3[i][4][0]
			} else {
				response += ". Would you like to tell me more about " + w3[i][0] + "?";
			}
			break;
		}
	}
	...
	for (var i in w3) {
		...
		if (matched) {
			if ( typeof w3[i][5] == "undefined" || w3[i][5].length == 0 ) {
				response = "Sorry, I don't think I know " + person + "'s birthdate.";
			} else {
	...
	for (var i in w3) {
		...
		if (matched) {
			if ( typeof w3[i][6] == "undefined" || w3[i][6].length == 0 ) {
				response = "Sorry, I don't think I know " + person + "'s hometown.";
			} else {
